---
id: 1
title: fix-vercel-deployment-css-links
stage: spec
date: '2025-12-11'
surface: agent
...
user: ruser
command: '/sp.specify also check after deployment on vercel my page is like that there is no css applied and even no link in working, while on local server it is working fine, also throughly check and fix this issue for work proper after deployment on vercel.'
labels:
  - spec
  - vercel
  - deployment
